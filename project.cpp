...
void project::largest_product_grid()
{
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The largest product of the given grid is: ";
    cout<<temp<<endl;
    cout<<"-------------------------------------------------------------------------------"<<endl;
}
...
void project::divisible_triangular_number()
{
    ...
    while (NumFactors <= 500)
	{
        ...
        cout<<"-------------------------------------------------------------------------------"<<endl;
        cout<<"The highly divisibe triangular number is: ";
		cout<<x<<endl;
		cout<<"-------------------------------------------------------------------------------"<<endl;
}
...
{
    uintmax_t num = 0;
    uintmax_t carry[50] = {0}, answer[50] = {0};
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The first 10 digits of the sum of the one-hundred 50 digit number is: ";
    for (row = 0; row <8; row++)
        cout<<answer[row];
    cout<<"\n";
    cout<<"-------------------------------------------------------------------------------"<<endl;
...
void project::longest_collatz_sequence()
{
   ...
   int longChainLength = 0;
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The starting number under one million which produces the longest chain is: ";
    cout<<longChainStartNum<<endl;
    cout<<"-------------------------------------------------------------------------------"<<endl;
}
...
void project::power_digit_sum()
{
	...
	cout<<"-------------------------------------------------------------------------------"<<endl;
	cout<<"The sum of the digits of the number 21000 is: ";
	cout <<sum<<endl;
    cout<<"-------------------------------------------------------------------------------"<<endl;
}

void project::number_letter_count()
{
    int sum=0,n=0;
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The sum of the number of letters from one to one thousand in words is: ";
    cout <<sum<<endl;
    cout<<"-------------------------------------------------------------------------------"<<endl;
}
...
void project::max_path_sum_one()
{
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The maximum total from top to bottom of the given triangle is: ";
    for (j=0; j<1; j++)
    {
        if (temp1[j]>=temp1[j+1])
...
{
    const int cal[48]={31,28,31,30,31,30,31,31,30,31,30,31,
                          31,28,31,30,31,30,31,31,30,31,30,31,
                          31,28,31,30,31,30,31,31,30,31,30,31,
                          31,29,31,30,31,30,31,31,30,31,30,31};
    const vector<int> cycle(cal, cal + sizeof(cal) / sizeof(cal[0]));

    int count = 0, nos=0;
    int a = 2;
    for (int i = 0; i < 25; ++i)
        {
            for (vector<int>::const_iterator b = cycle.begin();
            b < cycle.end(); ++b)
            {
                if (!a)
                count++;
    ...
    nos=(count);
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The number of Sundays fell on the first of the month during the 20th century is: "<<endl;
    cout<<nos<<endl;
    cout<<"-------------------------------------------------------------------------------"<<endl;
}
...
void project::factorial_digit_sum()
{
    ...
    cout<<"-------------------------------------------------------------------------------"<<endl;
    cout<<"The Factorial Digit Sum is: ";
